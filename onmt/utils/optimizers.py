...
def build_optim_mtl_params(mtl_params, opt, checkpoint):
    """ Build optimizer """
    ...
    # n_params = model.named_params(model)
    # for name, param in n_params:
    #     print(name)
    #optim.set_parameters(n_params)
    #optim.set_parameters(model.named_params(model))
    optim.set_parameters(mtl_params)
...
class Optimizer(object):
    ...
    def set_rate(self, learning_rate):
        self.learning_rate = learning_rate
        self.original_lr = learning_rate
