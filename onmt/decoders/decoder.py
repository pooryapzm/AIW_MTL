...
class RNNDecoderBase(MetaModule):#nn.Module):
    """
    ...
    def __init__(self, rnn_type, bidirectional_encoder, num_layers,
                 ...
                 reuse_copy_attn=False, main_decoder=None, mtl_opt=None):
...
class InputFeedRNNDecoder(RNNDecoderBase):
    ...
    def _build_rnn(self, rnn_type, input_size,
                   hidden_size, num_layers, dropout, main_decoder=None, mtl_opt=None):
        assert not rnn_type == "SRU", "SRU doesn't support input feed! " \
            "Please set -input_feed 0!"
        if not rnn_type.startswith("shared"):
            if rnn_type == "LSTM":
            ...
            if rnn_type == "sharedLSTM":
                return onmt.models.mtl_rnn.SharedLayerLSTM(num_layers=num_layers, input_size=input_size,
                                                         hidden_size=hidden_size, dropout=dropout,
                                                         mtl_opt=mtl_opt, main_rnn=main_decoder,
                                                         module_type="decoder")
