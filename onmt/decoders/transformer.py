...
class TransformerDecoder(nn.Module):
    ...
    def __init__(self, num_layers, d_model, heads, d_ff, attn_type,
                 copy_attn, self_attn_type, dropout, embeddings, main_decoder=None, mtl_opt=None):
        ...
        self.transformer_layers = nn.ModuleList()
        main_layers = None if main_decoder is None else main_decoder.transformer_layers
        for i in range(num_layers):
            ...
            if not is_layer_shared:
                ...
                #print("a decoder layer is shared!!!!")
                self.transformer_layers.append(main_layers[i])
