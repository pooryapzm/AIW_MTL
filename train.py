...
def main(opt):
    ...
    if opt.mtl_fully_share:
        opt.mtl_shared_vocab = True

    if opt.mtl_shared_vocab:
        if opt.mtl_shared_vocab_path=="":
            raise AssertionError("For using -mtl_shared_vocab or -mtl_fully_share, please specify -mtl_shared_vocab_path as well.")
